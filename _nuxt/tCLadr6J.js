import{_ as x,q as b,x as e,F as w,y as S,r as T,z as C,o as h,A as N,B as v}from"./C6kpJJ4q.js";const j={name:"TalkList",setup(){const p=T([]),c=t=>{const s=new Date(t),i=[s.getFullYear(),String(s.getMonth()+1).padStart(2,"0"),String(s.getDate()).padStart(2,"0"),String(s.getHours()).padStart(2,"0"),String(s.getMinutes()).padStart(2,"0")];return`${i[0]}-${i[1]}-${i[2]} ${i[3]}:${i[4]}`},m=(t,s)=>{var r,u,$,k;const i=c(t.createdAt);let n=t.content;const d=t.imgs?t.imgs.split(","):[];if(n=n.replace(/$$(.*?)$$$(.*?)$/g,'<a href="$2">@$1</a>').replace(/- $$ $$/g,"⚪").replace(/- $$x$$/g,"⚫").replace(/\n/g,"<br>"),d.length>0){const a=document.createElement("div");a.className="zone_imgbox",d.forEach(f=>{const l=document.createElement("a");l.href=f,l.setAttribute("data-fancybox","gallery"),l.className="fancybox",l.setAttribute("data-thumb",f);const y=document.createElement("img");y.src=f,l.appendChild(y),a.appendChild(l)}),n+=a.outerHTML}t.externalUrl&&(n+=`
        ...
        `}if(($=o.doubanBook)!=null&&$.id){const a=o.doubanBook;n+=`
          <a class="douban-card" href="${a.url}" target="_blank">
            <div class="douban-card-bgimg" style="background-image: url('${a.image}')"></div>
            <div class="douban-card-left">
              <div class="douban-card-img" style="background-image: url('${a.image}')"></div>
        ...
        `}if((k=o.video)!=null&&k.type){const a=o.video;a.type==="bilibili"?n+=`
