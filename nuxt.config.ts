	...
	app: {
		head: {
			...
			link: [
                ...
                { rel: 'preload', href: 'https://jsdmirror.yjluo.top/gh/661111/Myxz_Blog_Nuxt@master/public/fonts/zihunff/result.css?v=20260102', media: 'none', onload: 'this.media="all"'},
