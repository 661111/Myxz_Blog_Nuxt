	...
	app: {
		head: {
			...
			link: [
                ...
                { rel: 'stylesheet', href: 'https://cdn.jsdmirror.com/gh/661111/Myxz_Blog_Nuxt@master/public/fonts/jxzk/result.css', media: 'none', onload: 'this.media="all"', integrity: "sha512-H/6q0ZCB8t8FRzVxGnujXV2t6pKevObP0qoPIP0jmgJM/YD7CM+Dfx6o+q7LbaNRihXOm0rwSTTmrb/T/CBfQg==", crossorigin: "anonymous" },
