	...
	app: {
		head: {
			...
			link: [
                ...
                // { rel: 'stylesheet', href: 'https://jsdmirror.yjluo.top/gh/661111/Myxz_Blog_Nuxt@master/public/fonts/zihunff/font.css?v=20260102', media: 'none', onload: 'this.media="all"'},
                // { rel: 'stylesheet', href: 'https://static.vercel.sxiaohe.top/fonts/anzhiyu/anzhiyufonts.css', media: 'none', onload: 'this.media="all"'  },
				{ rel: 'preconnect', href: 'https://jsdmirror.yjluo.top' },
