	...
	app: {
		head: {
			...
			link: [
				...
				{ rel: 'stylesheet', href: 'https://nuxtsource.s3.bitiful.net/font/InterVariable/result.css', media: 'print', onload: 'this.media="all"' },
                ...
                { rel: 'stylesheet', href: 'https://jsd.myxz.top/npm/lxgw-wenkai-screen-web/lxgwwenkaiscreen/result.css', media: 'none', onload: 'this.media="all"' },
